...
function paychange(type) {
  ...
  if (type == "Full") {
    ...
    El_BBC_1_price.innerHTML = BBC_Full_price[1].toLocaleString() + ` ₽`;
    El_BBC_2_price.innerHTML = BBC_Full_price[2].toLocaleString() + ` ₽`;
    El_BBC_3_price.innerHTML = BBC_Full_price[3].toLocaleString() + ` ₽`;
    El_BBC_4_price.innerHTML = BBC_Full_price[4].toLocaleString() + ` ₽`;
    El_BBC_5_price.innerHTML = BBC_Full_price[5].toLocaleString() + ` ₽`;
    ...
    El_BBC_1_price.innerHTML = BBC_Inst_price[1].toLocaleString() + ` ₽`;
    El_BBC_2_price.innerHTML = BBC_Inst_price[2].toLocaleString() + ` ₽`;
    El_BBC_3_price.innerHTML = BBC_Inst_price[3].toLocaleString() + ` ₽`;
    El_BBC_4_price.innerHTML = BBC_Inst_price[4].toLocaleString() + ` ₽`;
    El_BBC_5_price.innerHTML = BBC_Inst_price[5].toLocaleString() + ` ₽`;
    El_Agreement_text.innerHTML =
